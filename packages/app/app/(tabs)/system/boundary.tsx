...
import {
  ...
  validateShape,
  type ShapeMode,
} from "@/components/polygon/ShapeEditor";
import { ShapeEditorBar } from "@/components/polygon/ShapeEditorBar";
import { ShapeEditorModeToggle } from "@/components/polygon/ShapeEditorModeToggle";
    ...
    return (
      <View style={[styles.fill, { backgroundColor: colors.bg }]} testID="boundary-screen">
        ...
        <View style={styles.centered}>
          ...
          <Text style={[textTokens.body, { color: colors.textMuted, marginTop: spacing.sm }]}>
            Loading…
          </Text>
        </View>
      </View>
