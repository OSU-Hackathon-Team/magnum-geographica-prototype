...
1.b 'Sub-System'
    * A group of physically or thematically connected trails within a System.
    * Should share a trailhead, signage, or maintenance unit.
    * Optional; omit unless there is a clear local grouping reason.
    * If it grows large enough to feel standalone, promote it to a System.
